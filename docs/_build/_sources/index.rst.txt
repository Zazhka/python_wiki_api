The Wikipedia API Python Project
================================
...
To install the WIkipedia API Python project,
run this command in your terminal:

.. code-block:: console

   $ pip install python-wiki-api


Usage
-----

Wikipedia API Python's usage looks like:

.. code-block:: console

   $ python-wiki-api [OPTIONS]
